...
class Portfolio:
    ...
    def reduce_position(self, ticker: str, sell_price: float, quantity_to_sell: int) -> Optional[Position]:
        """
        Reduz parcialmente uma posição do portfólio (Take-Profit parcial).

        Args:
            ticker: Código do ativo.
            sell_price: Preço de venda.
            quantity_to_sell: Quantidade de ações a vender.
